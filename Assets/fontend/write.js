                ...
                fetch:(callback)=>{
                  var items = [
                    ...
                    },
                    {
                      ...
                      onAction: function () {
                        editor.insertContent('<p>[su_spoiler title="合集目录" open="no" style="fancy " icon="plus" anchor="" class=""]</p><ol><li>请在这里编辑您的合集目录内容,可在上方<span style="background-color: rgb(53, 152, 219); color: rgb(255, 255, 255);" data-mce-style="background-color: #3598db; color: #ffffff;">自定义</span>列表样式</li></ol><p>[/su_spoiler]</p>');
                      }
                    },
                    {
                      type: 'menuitem',
